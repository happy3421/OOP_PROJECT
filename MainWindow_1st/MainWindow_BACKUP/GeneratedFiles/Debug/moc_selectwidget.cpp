...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SelectWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 56, 4)
    ...
    "SelectWidget\0goToGame\0\0goToTutorial\0"
    "goToShop\0goToStatus\0quit"
};
...
void SelectWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->goToTutorial(); break;
        case 2: _t->goToShop(); break;
        case 3: _t->goToStatus(); break;
...
const QMetaObject SelectWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SelectWidget.data,
      qt_meta_data_SelectWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SelectWidget.stringdata))
